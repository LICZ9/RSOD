...
class GroupMultiSourceSampler(MultiSourceSampler):
    ...
    def __init__(self,
        ...
        } for group in [0]]#range(len(self.group_ratio))]
        
                                
    def _get_source_group_info(self) -> None:
        self.group2size_per_source = [{0: 0}, {0: 0}]
        self.group2inds_per_source = [{0: []}, {0: []}]
        print(self.group2size_per_source )
    ...
    def __iter__(self) -> Iterator[int]:
        ...
        while True:
            ...
            #print('No data in this group, {} , please check the dataset'.format(len(batch_buffer)))
            yield from batch_buffer
            batch_buffer = []
