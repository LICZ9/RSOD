_base_ = [
    ...
    '../_base_/datasets/20semi_sonar_mnist_detection.py'
]
...
labeled_dataset.ann_file =  'annotations/instances_20train.json'
unlabeled_dataset.ann_file =  'annotations/instances_20unlabeled.json'
