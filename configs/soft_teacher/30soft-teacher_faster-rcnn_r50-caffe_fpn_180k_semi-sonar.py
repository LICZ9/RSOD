_base_ = [
    ...
    '../_base_/datasets/30semi_sonar_mnist_detection.py'
]
...
labeled_dataset.ann_file =  'annotations/instances_30train.json'
unlabeled_dataset.ann_file =  'annotations/instances_30unlabeled.json'
