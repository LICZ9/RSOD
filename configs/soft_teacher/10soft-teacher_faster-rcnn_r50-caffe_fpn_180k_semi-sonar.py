_base_ = [
    ...
    '../_base_/datasets/10semi_sonar_mnist_detection.py'
]
...
labeled_dataset.ann_file =  'annotations/instances_10train.json'
unlabeled_dataset.ann_file =  'annotations/instances_10unlabeled.json'
